...
import com.example.blog_application.service.userService.impl.UserDetailsServiceImpl;
...
//        String password = bCryptPasswordEncoder.encode("123123");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().and().formLogin()//
                ...
                .loginPage("/")//
                .defaultSuccessUrl("/create")// đăng nhập thành công -> call 1 request /userInfo
                .failureUrl("/?error=true")// đăng nhập thất bại -> /login?error = true
